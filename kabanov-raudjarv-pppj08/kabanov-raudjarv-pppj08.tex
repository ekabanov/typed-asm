...
\begin{verbatim}
  ...
  Alias<String> fullName = alias(concat(p.firstName,
    " ", p.lastName), "full_name");
...
new QueryBuilder(datasource)
  ...
  .closure(new ClosureC1<String>() {
    public void apply(SelectBuilderC1<C1>  builder) {
...
\textbf{TODO:} The examples is missing the refered additional closure.
